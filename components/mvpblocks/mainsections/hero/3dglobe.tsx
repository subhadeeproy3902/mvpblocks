  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto max-w-2xl px-4 text-center md:max-w-4xl md:px-6 lg:max-w-7xl">
        ...
        >
          <div className="w-full flex h-40 md:h-48 relative overflow-hidden">
            <img
              src="/assets/earth.png"
              alt="Earth"
              className="absolute px-4 md:-top-28 lg:-top-16 top-0 left-1/2 -translate-x-1/2 mx-auto -z-10 opacity-80"
            />
          </div>
          <div className="relative z-10 mx-auto max-w-5xl overflow-hidden rounded-lg shadow-[0_0_50px_rgba(155,135,245,0.2)]">
            <Image
              src="https://i.postimg.cc/gchKhZm1/2a6fe555-3b84-4d92-916e-70f34b15331b.png"
