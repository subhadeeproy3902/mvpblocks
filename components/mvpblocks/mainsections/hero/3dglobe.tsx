...
const World = dynamic(
  () => import("../../../ui/github-globe").then((m) => m.World),
  {
    ssr: false,
  },
);
...
export default function Globe3D() {
  const [globeConfig, setGlobeConfig] = useState(defaultGlobeConfig);
    ...
    >
      ...
      <div className="container relative z-10 mx-auto max-w-2xl px-4 text-center md:max-w-4xl md:px-6 lg:max-w-7xl">
        <div className="animate-fade-in-up">
          ...
          <div className="mb-48 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
        ...
        >
          <div className="absolute -top-56 z-10 h-96 w-full md:h-full md:w-[120%] left-1/2 -translate-x-1/2">
