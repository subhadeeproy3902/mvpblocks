            ...
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-20 xl:gap-[122px]">
              <div className="mx-auto max-w-[500px] lg:mx-0 lg:max-w-none">
                <div className="flex flex-col items-center justify-center text-center lg:items-start lg:justify-normal lg:text-left">
                  ...
                  <p className="mb-10 xl:mb-[50px]">
                    ...
                    set out realistic goals that you can accomplish without many
                  ...
                  <div className="mb-8 flex flex-wrap items-center gap-[10px] lg:mb-[50px]">
                    <div className="flex">
                      <img
                        src="https://mvpblocks.vercel.app/assets/fitness-hero/1.webp"
                      ...
                      />
                      <img
                        src="https://mvpblocks.vercel.app/assets/fitness-hero/2.webp"
                      ...
                      />
                      <img
                        src="https://mvpblocks.vercel.app/assets/fitness-hero/3.webp"
                        alt="hero-avatar-img-2"
                        width="58"
                        height="58"
                        className="-ml-[15px] h-[58px] w-[58px] rounded-[50%] first:-ml-0"
                    ...
                    <ul className="flex gap-12">
                      <li className="after:bg-black/20 dark:after:bg-white/20 relative after:absolute after:left-[calc(100%+_24px)] after:top-1/2 after:h-10 after:w-0.5 after:-translate-y-1/2 last:after:hidden">
                      ...
                      <li className="after:bg-ColorBlack/10 relative after:absolute after:left-[calc(100%+_24px)] after:top-1/2 after:h-10 after:w-0.5 after:-translate-y-1/2 last:after:hidden">
                        ...
                        <div className="flex gap-[5px] text-base">
                          <div className="flex gap-1">
                            <img
                              src="https://mvpblocks.vercel.app/assets/fitness-hero/icon.svg"
                              alt="icon-green-star"
                              width="17"
                              height="17"
                            />
                  ...
                  <div className="flex flex-wrap justify-center gap-5 sm:justify-normal">
                    <a href="#" className="group relative z-10 inline-block">
                      <Button className="rounded-full shadow-md shadow-foreground/30" size="lg">
              ...
              <div>
                <div className="relative z-10 mx-auto h-auto max-w-[280px] sm:max-w-[500px] lg:ml-auto lg:mr-0">
                  <img
                    src="https://mvpblocks.vercel.app/assets/fitness-hero/image.webp"
                    alt="hero-mobille"
                    width="612"
                    height="1272"
                  ...
                  />
                  <img
                    src="https://mvpblocks.vercel.app/assets/fitness-hero/shape1.svg"
                    alt="hero-2-shape-1"
                    width="110"
                    height="191"
                  ...
                  />
                  <img
                    src="https://mvpblocks.vercel.app/assets/fitness-hero/shape2.svg"
                    alt="hero-2-shape-1"
                    width="292"
                    height="299"
