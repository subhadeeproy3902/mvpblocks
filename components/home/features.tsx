    ...
    <section className="bg-background px-4 py-12 text-foreground sm:py-24 md:py-32">
      <div className="container mx-auto flex flex-col items-center gap-6 sm:gap-12">
        <div className="grid grid-cols-12 gap-4">
          <div
            data-slot="tile"
            className="group relative col-span-12 flex flex-col gap-6 overflow-hidden rounded-xl p-6 text-card-foreground shadow-xl transition-all md:col-span-6 lg:col-span-5"
          >
            <a
              data-slot="tile-link"
              className="absolute right-4 top-4 block rounded-full bg-accent/50 p-4 opacity-0 transition-opacity group-hover:opacity-100"
            >
              <svg
            ...
            <div data-slot="tile-content" className="flex flex-col gap-4">
              <h3
              ...
              <div
                ...
                className="text-md flex flex-col gap-2 text-balance text-muted-foreground"
              >
                <p>
                  Each block and component is carfully crafted—not generated by
                  AI—to give a unique look and feel AI would never come up with.
                </p>
              </div>
            </div>
            <div
              ...
              <div className="min-h-[300px] w-full py-12">
                ...
                >
                  <div
                    ...
                    className="absolute left-[50%] top-0 z-10 flex w-full max-w-[366px] -translate-x-[50%] translate-y-0 overflow-hidden rounded-[56px] bg-neutral-800/20 bg-secondary/50 p-2 transition-all duration-1000 ease-in-out group-hover:-translate-y-8 dark:bg-white/20"
                  >
                    <div
                      data-slot="mockup"
                      className="relative z-10 flex max-w-[350px] overflow-hidden rounded-[48px] border border-border/70 shadow-2xl dark:border-border/5 dark:border-t-border/15"
                    >
                      {theme === "light" ? (
                        <img
          ...
          <div
            data-slot="tile"
            className="group relative col-span-12 flex flex-col gap-6 overflow-hidden rounded-xl p-6 text-card-foreground shadow-xl transition-all md:col-span-6 lg:col-span-4"
          >
            <div data-slot="tile-content" className="flex flex-col gap-4">
              <h3
                data-slot="tile-title"
            ...
            >
              <div className="-ml-40 -mr-32">
                ...
                >
                  ...
                  <div className="fade-left-lg z-1 row-span-2 rounded-xl bg-gradient bg-gradient-to-b to-transparent from-black/5 transition-all duration-1000 ease-in-out dark:from-white/5"></div>
                  <div className="fade-top-lg z-1 row-span-2 rounded-xl bg-gradient-to-b to-transparent from-black/5 transition-all duration-1000 ease-in-out dark:from-white/5" />
                  <div className="glass rose relative z-10 row-span-2 flex items-center justify-center rounded-xl to-transparent outline-4 outline-border/30 transition-all duration-1000 ease-in-out group-hover:scale-105 dark:outline-background/30">
                    <div
                      data-slot="beam"
                      className="after:scale-200 after:bg-radial relative after:absolute after:inset-0 after:rounded-full after:from-primary-foreground/30 after:from-10% after:to-primary-foreground/0 after:to-60% after:content-['']"
                    >
                  ...
                  <div className="fade-bottom-lg z-1 row-span-2 rounded-xl bg-gradient-to-b to-transparent from-black/5 transition-all duration-1000 ease-in-out dark:from-white/5"></div>
                  <div className="glass rose relative z-10 row-span-2 row-start-2 flex items-center justify-center rounded-xl outline-4 outline-border/30 transition-all duration-1000 ease-in-out group-hover:scale-90 dark:outline-background/30">
                    <div
                      ...
                      className="after:scale-200 after:bg-radial relative after:absolute after:inset-0 after:rounded-full after:from-primary-foreground/30 after:from-10% after:to-primary-foreground/0 after:to-60% after:content-['']"
                    >
                      <div className="text-light relative z-10 h-8 w-8 flex justify-center items-center ">
                  ...
                  <div className="fade-top-lg z-1 row-span-2 rounded-xl bg-gradient-to-b to-transparent from-black/5 transition-all duration-1000 ease-in-out dark:from-white/5"></div>
                  <div className="glass rose relative z-10 row-span-2 flex items-center justify-center rounded-xl to-transparent outline-4 outline-border/30 transition-all duration-1000 ease-in-out group-hover:scale-105 dark:outline-background/30">
                    <div
                      data-slot="beam"
                      className="after:scale-200 after:bg-radial relative after:absolute after:inset-0 after:rounded-full after:from-primary-foreground/30 after:from-10% after:to-primary-foreground/0 after:to-60% after:content-['']"
                  ...
                  <div className="fade-right-lg z-1 row-span-2 rounded-xl bg-gradient-to-b to-transparent from-black/5 transition-all duration-1000 ease-in-out dark:from-white/5"></div>
