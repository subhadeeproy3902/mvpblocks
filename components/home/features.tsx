    ...
    <section className="bg-background px-4 py-12 text-foreground sm:py-24 md:py-32">
      <div className="container mx-auto flex flex-col items-center gap-6 sm:gap-12">
        <div className="grid grid-cols-12 gap-4">
          <div className="group relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 border-secondary/40 p-6 text-card-foreground shadow-xl transition-all md:col-span-6 lg:col-span-4">
            ...
            <div className="pointer-events-none flex grow select-none items-end justify-center">
              <div className="min-h-[300px] w-full py-12">
                <div className="relative h-full w-full">
                  <div className="absolute left-[50%] top-0 z-10 flex w-full max-w-[366px] -translate-x-[50%] translate-y-0 overflow-hidden rounded-[56px] bg-neutral-800/20 bg-secondary/50 p-2 transition-all duration-1000 ease-in-out group-hover:-translate-y-8 dark:bg-white/20">
          ...
          <div className="group relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 border-secondary/40 p-6 text-card-foreground shadow-xl transition-all md:col-span-6 lg:col-span-4">
            <div className="flex flex-col gap-4">
              ...
              <div className="text-md flex flex-col gap-2 text-sm text-muted-foreground">
                <p className="max-w-[460px]">
                Want to tweak visually? Open components in V0 and customize with ease — perfect for both devs and designers.
                </p>
              </div>
            </div>
            <div className="pointer-events-none flex grow select-none items-end justify-center"></div>
          </div>
        </div>
      </div>
    </section>
