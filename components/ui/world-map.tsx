          ...
          <g key={`points-group-${i}`}>
            <g key={`start-${i}`}>
              ...
              >
                <div className="w-6 h-6">
                  <Avatar className="w-6 h-6 border-2 border-white dark:border-gray-800 shadow-md">
                    <AvatarImage src={dot.start.avatar || "/placeholder.svg"} alt="Avatar" />
                    <AvatarFallback className="text-[8px] bg-rose-100 text-rose-800 dark:bg-rose-900 dark:text-rose-200">
            ...
            <g key={`end-${i}`}>
              ...
              >
                <div className="w-6 h-6">
                  <Avatar className="w-6 h-6 border-2 border-white dark:border-gray-800 shadow-md">
                    <AvatarImage src={dot.end.avatar || "/placeholder.svg"} alt="Avatar" />
                    <AvatarFallback className="text-[8px] bg-rose-100 text-rose-800 dark:bg-rose-900 dark:text-rose-200">
                      {dot.end.fallback || "SH"}
                    </AvatarFallback>
                  </Avatar>
