...
export function AuthorBadge({ username, className }: AuthorBadgeProps) {
  ...
  return (
    ...
    >
      <Badge 
        variant="outline" 
        className="flex relative items-center gap-1.5 bg-background/80 backdrop-blur-sm border-secondary/50 px-3.5 py-1.5 hover:bg-background/95 transition-colors shadow-[0px_0px_10px_0px_#ff005c40_inset]"
      >
