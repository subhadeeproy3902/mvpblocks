...
interface ExpandableProps {
  readonly children: React.ReactNode | ((props: { isExpanded: boolean }) => React.ReactNode)
...
export function ExpandableCardHeader(props: Readonly<React.HTMLAttributes<HTMLDivElement>>) {
  return <CardSection {...props} />
}

export function ExpandableCardContent(props: Readonly<React.HTMLAttributes<HTMLDivElement>>) {
  return <CardSection {...props} />
}

export function ExpandableCardFooter(props: Readonly<React.HTMLAttributes<HTMLDivElement>>) {
